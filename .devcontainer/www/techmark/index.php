...
<br>
    ...
    <section class="container mt-4 pt-5">
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imagenes/banner/imagen1.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/banner/imagen2.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/banner/imagen3.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/banner/imagen4.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/banner/imagen5.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/banner/imagen6.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                </div>
        ...
        <center>
            <br>
            <br>
            <h3>*REGISTRATE Y CONOCE NUESTRO PRODUCTOS Y SUS PRECIOS*<h3>

                    <a href="registro.php"><button class="btn btn-outline-success my-2 my-sm-0" type="submit"><i class='bx bx-message-square-edit'></i>Registrarse</button></a>
                    ...
                    <div>
                        ...
                        <form class="form-inline mt-2 pt-0">
            ...
            <div class="container">
                ...
                <div class="row py-4 d-flex align-items-center">
                    ...
                    <div class="col-md-6 col-lg-7 text-center text-md-right">
                        <!-- Facebook -->
                        <a class="fb-ic" target="_blank" href="">
                        ...
                        <!-- Twitter -->
                        <a class="tw-ic" target="_blank" href="">
                            <i class="fab fa-twitter white-text mr-4"> <img src="imagenes/Redes_sociales/twi.png" alt="..." width="45" height="45" class="img"> </i>
                        </a>
                        <!-- MAPAS -->
                        <a class="gplus-ic" target="_blank" href="">
                            <i class="fab fa-google-plus-g white-text mr-4"> <img src="imagenes/Redes_sociales/mapa.png" alt="https://goo.gl/maps/ppE2Fb8w4qmCEAnA6" width="50" height="50" class="img"> </i>
                        </a>
